...
#r_pf = ny.get_spherical_position(lat_pf, long_pf, traj_arrays)
#r_vt = ny.get_spherical_position(lat_vt, long_vt, traj_arrays)
#r_tl = ny.get_spherical_position(lat_tl, long_tl, traj_arrays)
#times_interp = ut.interp_position(times, sample_rate, positions[:,:,Receiver.PF.value], start_time, end_time)[0]
...
#r_pf_interp = ut.interp_position(times, sample_rate, r_pf, start_time, end_time)
#r_pf_interp_cart = ut.interp_position(times, sample_rate, r_pf, start_time, end_time, coord_system="cartesian")
#r_vt_interp = ut.interp_position(times, sample_rate, r_vt, start_time=start_time, end_time=end_time)
#r_vt_interp_cart = ut.interp_position(times, sample_rate, r_vt,start_time=start_time, end_time=end_time, coord_system="cartesian")
#r_tl_interp = ut.interp_position(times, sample_rate, r_tl,start_time=start_time,end_time=end_time)
#r_tl_interp_cart = ut.interp_position(times, sample_rate, r_tl,start_time=start_time,end_time=end_time, coord_system="cartesian")
...
print((losses[:,Receiver.PF.value,0]**2).min())
print((losses[:,Receiver.PF.value,0]**2).max())
############################################ Calculations ############################################
# polarization losses
# identical to containerized
#pf_losses_ew=ut.get_polarization_loss(receivers_ew,transmitters_aligned,r_pf_interp_cart)
#pf_losses_ns=ut.get_polarization_loss(receivers_ns,transmitters_aligned,r_pf_interp_cart)
#vt_losses_ew=ut.get_polarization_loss(receivers_ew,transmitters_aligned,r_vt_interp_cart)
#vt_losses_ns=ut.get_polarization_loss(receivers_ns,transmitters_aligned,r_vt_interp_cart)
#tl_losses_ew=ut.get_polarization_loss(receivers_ew,transmitters_aligned,r_tl_interp_cart)
#tl_losses_ns=ut.get_polarization_loss(receivers_ns,transmitters_aligned,r_tl_interp_cart)
